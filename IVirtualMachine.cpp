...
#define VARNAME TEXT("Path")
	...
	const char * baseDir = "";//getJavaHome();
	const char * dylib = nullptr;///findLib(baseDir);
	const char * jli = nullptr;//getJavaJli();


	//we look to the environment for an embedded path
	const char * embeddedEnvironment = getenv("EMBEDDED_JVM_LIBRARY_PATH");
	const char * embeddedJliEnvironment = getenv("EMBEDDED_JLI_LIBRARY_PATH");


//// we're forcing the environment here
//const char* JAVA_EMBED_BASE_DIRECTORY ="/Applications/LiquidRhythm.app/Contents/Resources/Java";
//
///* CPU(X86_64) - AMD64 / Intel64 / x86_64 64-bit */
//#if   defined(__x86_64__) || defined(_M_X64)
//
//const char* JAVA_JRE_OSX_BASE_DIRECTORY = "/jre/zulu-8.jre";
//const char* JAVA_JRE_JVM_FILE = "/jre/Contents/Home/lib/server/libjvm.dylib";
//const char* JAVA_JRE_JLI_FILE = "/jre/Contents/MacOS/libjli.dylib";
//
//#endif
//
///* CPU(ARM64) - Apple */
//#if (defined(__arm64__) && defined(__APPLE__)) || defined(__aarch64__)
//const char* JAVA_JRE_OSX_BASE_DIRECTORY = "/jre-arm64/zulu-8.jre";
//const char* JAVA_JRE_JVM_FILE = "/jre-arm64/Contents/Home/lib/server/libjvm.dylib";
//const char* JAVA_JRE_JLI_FILE = "/jre-arm64/Contents/MacOS/libjli.dylib";
//#endif
//
//std::string jvmdylib(JAVA_EMBED_BASE_DIRECTORY);
//jvmdylib.append(JAVA_JRE_JVM_FILE);
//
//
//std::string jvmjli(JAVA_EMBED_BASE_DIRECTORY);
//jvmjli.append(JAVA_JRE_JLI_FILE);
//
//embeddedEnvironment = jvmdylib.data();
//embeddedJliEnvironment = jvmjli.data();
